<!--
 * @Author: your name
 * @Date: 2021-08-26 15:32:01
 * @LastEditTime: 2021-08-26 15:33:57
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \mes\src\components\MultiSelect\index.vue
-->
<template>
  <el-select
  ...
  >
    <el-option v-if="options.length" label="全选" value="全选">
      <el-checkbox v-model="isSelectAll" @click.prevent.native
        >全选</el-checkbox
      >
    </el-option>
    <el-option
