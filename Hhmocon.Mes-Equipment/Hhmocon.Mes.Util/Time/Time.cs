...
namespace Hhmocon.Mes.Util
{
    ...
    public class Time
    {
        ...
        /// 短日期格式(yyyy/MM/dd)
        /// </summary>
        public static string ShortDate => Now.ToString("yyyy/MM/dd");
        /// <summary>
        /// 长日期格式(yyyy月MM日dd日)
        /// </summary>
        public static string LongDate => Now.ToString("yyyy月MM日dd日");
        /// <summary>
        /// 日期时间(yyyy/MM/dd HH:mm)
        /// </summary>
        public static string ShortDateTime => Now.ToString("yyyy/MM/dd HH:mm");
        /// <summary>
        /// 日期时间(yyyy年MM月dd日 HH时mm分)
        /// </summary>
        public static string LongDateTime => Now.ToString("yyyy年MM月dd日 HH时mm分");

        /// <summary>
        /// 日期时间(yyyy年MM月dd日 HH时mm分)
        /// </summary>
        public static string LongTime => Now.ToString("HH时mm分");

        /// <summary>
        /// 日期时间(yyyy年MM月dd日 HH时mm分)
        /// </summary>
        public static string ShortTime => Now.ToString("HH:mm");
        /// <summary>
        /// 当前日期
        /// </summary>
        /// <returns></returns>
