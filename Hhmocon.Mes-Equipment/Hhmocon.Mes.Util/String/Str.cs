...
namespace Hhmocon.Mes.Util
{
    ...
    public sealed partial class Str
    {
        ...
        /// 返回带单引号的字符串
        /// </summary>
        /// <param name="str">用逗号分隔的字符串“abc,bcd”</param>
        /// <returns>"'abc','bcd'"</returns>
        public static string SingleQutotationString(string[] str)
        {
            ...
            try
            {
                if (str.Length > 0)
                {
                    ...
                    {
                        strtemp = str[i];
                        if ((strtemp.IndexOf("'") == 0) && (strtemp.LastIndexOf("'") == 0))
                        {
        ...
        public static string SingleQutotationString(string str)
        {
            ...
            try
            {
                ...
                if (strArr.Length > 0)
                {
                    ...
                    {
                        strtemp = strArr[i];
                        if ((strtemp.IndexOf("'") == 0) && (strtemp.LastIndexOf("'") == strtemp.Length - 1))
                        {
        ...
        /// <returns></returns>
        public static string EraseSingleQutotationString(string str)
        {
            string strtemp = string.Empty;
            try
            {
        ...
        /// 拼音码
        /// </summary>
        private static readonly int[] ChinesePinYinValue = new int[]
        {
        ...
        ///  拼音码
        /// </summary>
        private static readonly string[] ChinesePinYinName = new string[]
        {
        ...
        public static string GetLastProperty(string propertyName)
        {
            ...
            int lastIndex = propertyName.LastIndexOf(".", StringComparison.Ordinal) + 1;
