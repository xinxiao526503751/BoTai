...
namespace Hhmocon.Mes.Core
{
    /// <summary>
    /// 定义异步操作类（使用Stephen Toub线程池的异步策略）
    /// </summary>
    public partial class AsynStrategy : IAsynStrategy
    {

    }
    /// <summary>
    /// Managed thread pool.
    /// Stephen Toub用C#托管代码实现的线程池
    ...
    public class ManagedThreadPool
    {
        ...
        public static int MaxThreads => _maxWorkerThreads;
